...
import {addCourse, CourseRequest, Language} from "../../util/APIUtils";
...
export const CourseForm = ({user}: CourseFormProps) => {
    ...
    async function handleSubmit() {
        const courseRequest: CourseRequest = {
            name: name!,
            languageA: teachingLanguage!,
            languageB: baseLanguage!
        }
        try {
            const newCourse: { id: number } = await addCourse(courseRequest);
    ...
    return (
        <div className="form-container">
            ...
            <div className="form-content">
                ...
                >
                    ...
                    >
                        <Select
                            ...
                            onChange={value => setTeachingLanguage(value)}
                        />
                    </Form.Item>
                ...
                <button onClick={() => {
                    console.log(`name ${name}, teaching ${teachingLanguage},  base language ${baseLanguage}`)
                }}>log
                </button>
            </div>
        </div>
